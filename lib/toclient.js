...
let mailDetails = {
    ...
    <body>
        ...
        <p>The code below is your apikey, please don't share it with anyone else. The maximum limit of this apikey is 20/day, if you want to update this apikey (send more requests), please contact the <a href="https://wa.me/+447438517627?text=I+need+more+request,+can+you+provide+your+pricing?">admin</a>. *thanks*</p>
...
async function WhatsBotConnect() {
	...
	const msgs = chatUpdate.messages[0].message.conversation;
	...
	sendWa.on('apikey', async ({id,key}) => {
			...
			contextInfo:{
				externalAdReply: {
						title: `inrl-api-bot`,
						thumbnailUrl: logo,
						sourceUrl: 'https://wa.me/+447438517627?text=I+need+more+request,+can+you+provide+your+pricing?'
					}
				}
		      })
		await conn.sendMessage(id, {
...
module.exports = {sendMail,sendApiKeyMail,sendWa};
