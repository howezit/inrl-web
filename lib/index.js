...
const {getkeys,addkey,updateFully,removeKey,toPremiumKey} = require('./apikey');
const {morece_encode,decode_morece,jsObfuscate,uglifyJS,beautifyJs,beautifyCSS,beautifyHTML} = require('./programs');
const {
	ahegao
