...
async function gfx9(text) {
	registerFont('AVENGEANCE HEROIC AVENGER.ttf', {
		family: 'Sora',
	});
	const canvas = createCanvas(840, 840)
	const img = await loadImage('./gfx9.jpg');
	const context = canvas.getContext('2d');
	...
	context.stroke();
	fs.writeFileSync(`./temp/gfx9.png`, imgBuffer)
	return `/temp/gfx9.png`;
}
...
async function gfx10(text) {
	...
	const canvas = createCanvas(840, 840)
	const img = await loadImage('./gfx10.jpg');
	const context = canvas.getContext('2d');
	context.drawImage(img, 0, 0, 840, 840)
	context.font = '130px Sora';
	...
	context.stroke();
	const imgBuffer = canvas.toBuffer('image/png')
	fs.writeFileSync(`./temp/gfx10.png`, imgBuffer)
	return `/temp/gfx10.png`;
}
async function gfx11(text) {
	...
	const canvas = createCanvas(840, 840)
	const img = await loadImage('./gfx11.jpg');
	const png = await loadImage('./gfx11.png');
	const context = canvas.getContext('2d');
	context.drawImage(img, 0, 0, 840, 840)
	context.font = '130px Sora';
	context.shadowBlur = 20;
	...
	context.stroke();
	const imgBuffer = canvas.toBuffer('image/png')
	fs.writeFileSync(`./temp/gfx11.png`, imgBuffer)
	return `/temp/gfx11.png`;
}
async function gfx12(text) {
	...
	const canvas = createCanvas(840, 840)
	const img = await loadImage('./gfx12.jpg');
	const png = await loadImage('./gfx12.png');
	const context = canvas.getContext('2d');
	context.drawImage(img, 0, 0, 840, 840)
	context.font = '130px Sora';
	context.shadowBlur = 20;
	...
	context.stroke();
	const imgBuffer = canvas.toBuffer('image/png')
	fs.writeFileSync(`./temp/gfx12.png`, imgBuffer)
	return `/temp/gfx12.png`;
}
