...
async function gfx4({
    ...
    const imgBuffer = canvas.toBuffer('image/png')
    fs.writeFileSync(`./gfx_img4.png`, imgBuffer)
    return `/temp/gfx_img4.png`;
}
...
async function gfx5({
    ...
    const canvas = createCanvas(1280, 1280)
    const img = await loadImage('./temp/temp/gfx4/gfx5.jpg');
    const context = canvas.getContext('2d');
    context.drawImage(img, 0, 0, 1280, 1280)
    ...
    const imgBuffer = canvas.toBuffer('image/png')
    fs.writeFileSync(`./gfx_img5.png`, imgBuffer)
    return `/temp/gfx_img5.png`;
}
...
async function gfx6({
    ...
    const imgBuffer = canvas.toBuffer('image/png')
    fs.writeFileSync(`./gfx_img6.png`, imgBuffer)
    return `/temp/gfx_img6.png`;
}
