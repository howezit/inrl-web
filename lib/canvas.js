...
context.fillText(options.text , 420, 1070,options.text.length *60);
context.lineWidth = 7;
context.strokeText(options.text, 420, 1070,options.text.length *60);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.fillText(options.text , 200, 635,options.text.length *27);
context.lineWidth = 6;
context.strokeText(options.text, 200, 635,options.text.length *27);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.font = `bold ${options.text.length *6}px fangsong`
context.textAlign = 'center'
context.textBaseline = 'bottom';
context.fillStyle = options.color;
context.strokeStyle = options.border;
context.fillText(options.text , 275, 555,options.text.length *29);
context.lineWidth = 4;
context.strokeText(options.text, 275, 555,options.text.length *29);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.fillText(options.text , 200, 650,options.text.length *25);
context.lineWidth = 4;
context.strokeText(options.text, 200, 650,options.text.length *25);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.font = `bold ${options.text.length *5}px fangsong`
context.textAlign = 'center'
context.textBaseline = 'bottom';
context.fillStyle = options.color;
context.strokeStyle = options.border;
context.fillText(options.text , 220, 580,options.text.length *25);
context.lineWidth = 4;
context.strokeText(options.text, 220, 580,options.text.length *25);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
