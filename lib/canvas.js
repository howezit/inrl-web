...
context.lineWidth = 7;
context.strokeText(options.text, 420, 1070,text.length *60);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.lineWidth = 6;
context.strokeText(options.text, 200, 635,text.length *27);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.lineWidth = 4;
context.strokeText(options.text, 275, 555,text.length *29);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.lineWidth = 4;
context.strokeText(options.text, 200, 650,text.length *25);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
...
context.lineWidth = 4;
context.strokeText(options.text, 220, 580,text.length *25);
context.stroke();
  const imgBuffer = canvas.toBuffer('image/png')
  fs.writeFileSync(`./temp/${options.path}`,imgBuffer)
  return `/temp/${options.path}`;
