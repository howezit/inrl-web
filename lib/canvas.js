...
context.fillText(text , 420, 1070,text.length *60);
context.lineWidth = 7;
...
context.fillText(text , 200, 635,text.length *27);
context.lineWidth = 6;
...
context.fillStyle = options.color;
context.strokeStyle = options.border;
context.fillText(text , 275, 555,text.length *29);
context.lineWidth = 4;
...
context.fillText(text , 200, 650,text.length *25);
context.lineWidth = 4;
...
context.fillStyle = options.color;
context.strokeStyle = options.border;
context.fillText(text , 220, 580,text.length *25);
context.lineWidth = 4;
